...
{
    /// <inheritdoc />
    public partial class CreatingAirSliderFlightManagementDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FlightBookingId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FlightBookingStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BookingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateOfTravel = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FlightNumber = table.Column<long>(type: "bigint", nullable: false),
                    FlightScheduleId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FlightBookings_AspNetUsers_PassengerId",
